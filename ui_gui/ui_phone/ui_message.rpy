                ...
                if player.aco_p>10:
                    frame:
                        ...
                        imagebutton idle "gui/phone/address/Acolas.png":
                            action [Hide("info"),Hide("screen_phone_message_address"),Show(screen="screen_phone_message_weixin",who='Acolas', player=player)]
                ...
                if player.hal_p>10:
                    frame:
                        ...
                        imagebutton idle "gui/phone/address/Halluke.png":
                            action [Hide("info"),Hide("screen_phone_message_address"),Show(screen="screen_phone_message_weixin",who='Halluke', player=player)]
                ...
                if player.dep_p>10:
                    frame:
                        ...
                        imagebutton idle "gui/phone/address/Depline.png":
                            action [Hide("info"),Hide("screen_phone_message_address"),Show(screen="screen_phone_message_weixin",who='Depline', player=player)]
...
screen screen_phone_message_weixin(who, player, trans=trans_Down()):
    ...
    frame:
                            ...
                            frame:
                                ...
                                vbox:
                                    text '{color=#000000}{size=-17}{font=C.ttf}'+i.fro+'{/font}{/color}{/size}':
                                        xalign ali
                                    null height 7
                                    text '{color=#000000}{size=-10}'+i.what+'\n{/color}{/size}':
                                        xalign ali
        ...
        frame:
            ...
            imagebutton auto "gui/phone/message/send_%s.png":
                action [Function(Message.new, player, player.name, who, send), Hide("screen_phone_message_weixin"), Show(screen = "screen_phone_message_weixin", who=who, player=player, trans=None)]
                hover_sound audio.cursor
    ...
    key 'K_RETURN' action [Function(Message.new, player, player.name, who, send), Hide("screen_phone_message_weixin"), Show(screen = "screen_phone_message_weixin", who=who, player=player, trans=None)]
    key 'K_KP_ENTER' action [Function(Message.new, player, player.name, who, send), Hide("screen_phone_message_weixin"), Show(screen = "screen_phone_message_weixin", who=who, player=player, trans=None)]
