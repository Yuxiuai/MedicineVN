...
label halluke_route_2:
    ...
    play music audio.varsitylife fadein 5
    "今天的课程结束了。"
    "自由练习时间，老师要求随意找人搭配训练发球和击球。"
    "而我只是个外来人，那些大学生们也都互相认识，提前约好一般均匀排列在我所在场地附近的球网两排。"
    "和上周一样，那个孩子仍然在和老师的演示中表现出色，仍然在球场的另一侧，和其他人打着球。"
    "而我在干什么？"
    "我拿着球拍，站在橙红的羽毛球场一侧，仿佛一个局外人。"
    "找不到一同练习的学生，也没有事情可做。"
    "我享受这种生活吗？"
    "抑郁情绪总是来得突然，更可恶的是还会带上从内核辐射到整颗头颅的痛苦。"
    "啊…啊……"
    scene court_window with dissolve
    "我走到窗台一侧，将球拍网那一端杵在地上，然后将握柄靠在窗台同侧的墙上。"
    "…"
    "呼吸，呼吸……"
    "我试着尽量让鼻子吸入足够的空气，足以让埋藏于我胸口的器官填满空气。"
    "我的胸部随着深呼吸抬起，再缓慢地吐出，牵动所谓的膈肌运动。"
    "我抬起空闲出来的爪子，攥成拳头，用食指突出的关节挤压太阳穴。"
    "适当地按压偶尔可以缓解，但转移注意力也许要比这种方法管用得多。"
    "我叹气。"
    "好吧，继续。"
    "和上次一样。"
    scene court with fade
    show halluke angry_eyes sweat with dissolve
    "当我再次拿起手机佯装刷莓博时，屏幕里的画面从单调的橙黄色塑胶地板逐渐开始浮现出他的身影。"
    "我就靠在离他最近的窗台边。"
    ...
    "等等，不会是…"
    show halluke with dissolve
    "一个白色毛发的身影穿过门缝，挤进我的视野中。"
    show halluke normalpee with dissolve
    "而后他缓慢拉下裤子，将那象征雄性身份的阳物掏出。"
    play sound audio.pee fadein 2
    "我看着眼前被白毛包裹着的小家伙，正用爪子扶着柔软的粉色阳物，对着便池排放出尿液。"
    "天，一定是上帝的祝福。"
    play music audio.masturbation
    "我尽量小声地继续撸动自己那物，再欣赏正前方正在小便的Halluke。"
    "他似乎尿了很久，也许是沉迷打球没时间上厕所。"
    "是的，那根粉色的阴茎仍然排放着尿液。"
    "虽然有些过于变态，如果他正对着我的脸排泄……"
    play audio audio.heartbeat
    "啊啊…我…我在想什么啊…可……"
    "如果…如果………"
    "…呃…呃呃啊……"
    "…"
    ...
    scene black
    stop music
    "伴随着大量液体通过尿道带来的快感，当我回过神来时，肚子上的毛已经都白色乳液揉成一团了。"
    "我再次从门缝向外看。"
    scene toilet with dissolve
    "外面并没有人，他应该已经离开了。"
    "…"
    "天…我怎么会这么大胆。"
    "我厕所隔间的墙上拽出一段纸巾，清理着腹部乱糟糟的毛发。"
    "我再一次深呼吸。"
    "看来转移注意力确实是有用的，至少在我快乐的那一小段时光里，我完全没有注意到那折磨人的头疼。"
    "…"
...
label halluke_route_9:
    ...
    show halluke smile_mouth with dissolve
    h"“叫我Halluke吧。”"
    "啊……糟了，虽然已经和他打球这么多次了，我们甚至都没自我介绍过。"
    "平时完全都是靠眼神交流的。"
    $ss()
    s"“……我，我的名字是……”"
    $ss('smile_mouth normal2_eyes blush')
    s"“叫我[p.name]吧。”"
    $sh()
    show halluke awkward_eyebrow awkward_eyes with dissolve
    h"“我记住了。”"
    "不可否认的是，我们的关系正在稳步向前。"
    "虽然花了很长时间，但我们已经能像朋友那样正常聊天了。"
...
label halluke_route_10:
    ...
    "我抬手，抓住了他的衣领。"
    "他身边的人见我似乎对他有危险，摆出了准备和我打一架的架势。"
    "我能从手上感受到，他正在发抖。"
    "即便如此，他还是抬头，对着我身边的人摇了摇头。"
    h"“对不起，如果你生气了，就揍我吧。”"
    h"“然后…不要再来了。”"
    "是啊，发泄愤怒吧，发泄愤怒吧。"
    ...
    "在冷风的吹拂下，我终于安静下来了。"
    "如果让我现在去亲，都不用在体育场，就算跑到只有我和他在的地方，我也没那个勇气。"
    ...
    "我越过门槛，走进了他的家里。"
    "…"
    "他的家里十分简陋，能从客厅直接看到厨房和卧室的门，而且面积看起来也十分小。"
    ...
    h"“嗯…”"
    h"“我出来住的原因是，家里氛围不太好。”"
    h"“自从我很小的时候，父母就总是在吵架了，我搬出家里住后没多久，他们就离婚了。”"
    h"“也许是那样的环境，从小没人和我说话，我也不能表达自己的想法。”"
    h"“所以才变得不太能流利地跟别人，尤其是不太熟的人说话吧。”"
    s"“这意味着，我们已经是熟人了。”"
    "他笑了笑，用毛巾擦拭洗手池的水渍。"
    h"“现在想来，也许是我很没有安全感吧。”"
    h"“之前和你在一起打球的时候，我感觉很安心诶。”"
    "他回头看我，而我只是站在那里，看着他。"
    h"“在学校里我只和同学进行一些简单的交流而已，除了打羽毛球的时候。”"
    h"“我很喜欢打羽毛球，这让我看起来不像个怪物。”"
    h"“后来我遇见了你。”"
    h"“…你也很厉害，但我最初单纯只是觉得，这样。”"
    ...
    h"“我怕我会依赖你，我怕我们的关系会像我父母那样不稳定。”"
    h"“再加上我根本不了解你这位根本不属于我们学校的人是什么来头，在这门课程结束之后，我们便失去了能够一起沟通的东西。”"
    h"“也许我不会再来到这个体育馆，也许你觉得自己已经结束了课程，该上点别的课了。”"
    h"“然后…我自己就和自己闹别扭了吧…有一些想不开…”"
    h"“如果我我把你删了，应该就能回归到原来的平静生活了。”"
    h"“也不用担心，自己会被抛弃…或者乱七八糟的东西……”"
    ...
    h"“我一开始也害怕你做的只是朋友应该做的事而已，我也害怕你没法接受我。”"
    h"“…就算是骗我，你也认真地骗了我，这就够了。”"
    h"“你喜不喜欢我，其实也无所谓了。”"
    ...
    menu:
        ...
        "离开" if not replaying or (replaying and p.hal_p == 99):
            ...
            if p.hal_p == 11:
                $p.hal_p = 99
        "我们还是做朋友吧" if not replaying or (replaying and p.hal_p == 99):
