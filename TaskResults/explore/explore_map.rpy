screen screen_explore_map(player):
    ...
    frame:
        ...
        imagebutton auto "imagemap/ShoppingStreet_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="screen_explore_shopstreet_map", player=player)]
            hover_sound audio.cursor
...
screen screen_explore_shopstreet_map(player):
    tag menu
    #tag gamegui
    zorder 900
    frame:
        at map_appear
        background "imagemap/shopstreet/background.png"
        ...
        $info11 = "\n{size=-5}当前版本无法进入。{/size}"
        $ad1 = '一想到这里面每天晚上都有很多人在同时做爱，就十分不可思议。'
        imagebutton auto "imagemap/shopstreet/hotel_%s.png":
            focus_mask True
            #action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("info_confirm"),Return(),Jump("explore_bookshop")], pp=renpy.get_mouse_pos(),i=info1+info11, a=ad1)]
            action NullAction()
            hover_sound audio.cursor
        ...
        imagebutton auto "imagemap/shopstreet/flowershop_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_6")], pp=renpy.get_mouse_pos(),i=info2+info22, a=ad2)]
            hover_sound audio.cursor
            hovered Show("info",i=info2+info22, a=ad2)
            unhovered Hide("info")
        
        $info3 = "{size=+8}游戏厅{/size}" if 1 in p.visitedStore else '{size=+8}？？？{/size}\n'
        $ad3 = '不是我不喜欢打游戏，只是一激动，一失败，或者只是玩的久一些，我的头就会疼到脑壳都炸开。' if 1 in p.visitedStore else '？？？？？？？？？？？？'
        $info33 = "\n{size=-5}夹娃娃{/size}" if 1 in p.visitedStore else '\n{size=-5}还没去过这里，来这里逛一逛吧？{/size}'
        imagebutton auto "imagemap/shopstreet/gameroom_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_1")], pp=renpy.get_mouse_pos(),i=info3+info33, a=ad3)]
            hover_sound audio.cursor
            hovered Show("info",i=info3+info33, a=ad3)
            unhovered Hide("info")
        ...
        imagebutton auto "imagemap/shopstreet/snackshop_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_2")], pp=renpy.get_mouse_pos(),i=info4+info44, a=ad4)]
            hover_sound audio.cursor
            hovered Show("info",i=info4+info44, a=ad4)
            unhovered Hide("info")
        ...
        imagebutton auto "imagemap/shopstreet/cafe_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_5")], pp=renpy.get_mouse_pos(),i=info5+info55, a=ad5)]
            hover_sound audio.cursor
            hovered Show("info",i=info5+info55, a=ad5)
            unhovered Hide("info")
        ...
        imagebutton auto "imagemap/shopstreet/giftshop_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_4")], pp=renpy.get_mouse_pos(),i=info6+info66, a=ad6)]
            hover_sound audio.cursor
            hovered Show("info",i=info6+info66, a=ad6)
            unhovered Hide("info")
        ...
        imagebutton auto "imagemap/shopstreet/toolshop_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_7")], pp=renpy.get_mouse_pos(),i=info7+info77, a=ad7)]
            hover_sound audio.cursor
            hovered Show("info",i=info7+info77, a=ad7)
            unhovered Hide("info")
        ...
        imagebutton auto "imagemap/shopstreet/food_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_3")], pp=renpy.get_mouse_pos(),i=info8+info88, a=ad8)]
            hover_sound audio.cursor
        ...
        imagebutton auto "imagemap/shopstreet/sportshop_%s.png":
            focus_mask True
            action [Hide("info"), Show(screen="info_confirm",text='去这里',act=[Hide("screen_explore_map"),Hide("screen_explore_shopstreet_map"),Hide("info_confirm"),Return(),Jump("explore_shop_8")], pp=renpy.get_mouse_pos(),i=info9+info9, a=ad9)]
            hover_sound audio.cursor
    ...
    hbox:
        ...
        imagebutton auto "gui/menu/home_%s.png":
            at map_appear
            action [Hide("screen_explore_shopstreet_map",transition=dissolve),Hide("info")]
            unhovered Hide("info")
