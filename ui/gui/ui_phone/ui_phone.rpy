...
screen screen_phone(player):
    ...
    frame:
        ...
        imagebutton idle "gui/phone/leviathan.png":
            ...
            focus_mask True
            hovered Show(screen="info", i=_('普通的小猫咪壁纸，完全没有什么特别之处。'), a=_('看什么看，你个三流程序员。'))
            unhovered Hide("info") 
            xcenter 0.52
            ycenter 0.34
        ...
        frame:
            ...
            hbox:
                ...
                imagebutton auto "gui/phone/game_%s.png":
                    ...
                    hovered Show(screen="info", i=_('经典的小游戏2048。'), a=_('关于我平时摸鱼的时候都在干什么。'))
                    unhovered Hide("info")  
                ...
                imagebutton auto "gui/phone/camera_%s.png":
                    ...
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('相机\n查看角色立绘。'), a=_('偷拍婆的隐藏文件夹……等等，这拍的也太多了，还这么全面？'))
                    unhovered Hide("info")   
                ...
                imagebutton auto "gui/phone/plot_%s.png":
                    ...
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('视频播放器\n回顾人物剧情。'), a=_('缅怀某个叫做网课的东西。'))
                    unhovered Hide("info")  

                imagebutton auto "gui/phone/pic_%s.png":
                    action NullAction()
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('相册\n欣赏CG。\n\n（当前版本尚未开放，因为还没有CG，哈哈。）'), a=_('一般我们都会管这个叫“画廊”，不过那听起来也太高贵了。'))
                    unhovered Hide("info")  
        ...
        frame:
            ...
            hbox:
                ...
                imagebutton auto "gui/phone/write_%s.png":
                    ...
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('写作平台\n通过接委托，完成委托或上传随笔来获得人气和报酬。\n接取的委托在所持物品中。'), a=_('什么时候写东西也像画画那样来钱快粉丝涨的也快就好了……'))
                    unhovered Hide("info")  
        ...
        frame:
            ...
            hbox:
                ...
                imagebutton auto "gui/phone/call_%s.png":
                    ...
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('联系人\n和你的朋友打个电话聊聊天吧。'), a=_('谁会直接和！送外卖的店家！打电话！啊！'))
                    unhovered Hide("info")   
                $newmes = False
                ...
                if Message.hasNewMes(player):
                    imagebutton auto "gui/phone/new_%s.png":
                        ...
                        hover_sound audio.cursor
                        hovered Show(screen="info", i=_('某信\n有新消息了。'), a=_('“永远爱你”\n“啊对对”'))
                        unhovered Hide("info")  
                else:
                    imagebutton auto "gui/phone/message_%s.png":
                        action [Hide("info"),Hide("screen_phone"),Show(screen = "screen_phone_message_address", player = player)]
                        hover_sound audio.cursor
                        hovered Show(screen="info", i=_('某信\n和已经添加手机号的朋友聊天。'), a=_('“永远爱你”\n“啊对对”'))
                        unhovered Hide("info")   
                imagebutton auto "gui/phone/browser_%s.png":
                    if Message.hasMes(player, 'Pathos', 'sb'):
                        action [Function(Achievement800.achieve), Function(Achievement.show), Hide("info"),Hide("screen_phone",transition=dissolve),Hide("screen_phone_bg",transition=dissolve),Show(screen="screen_phone_cheat", player = player)]
                    else:
                        action NullAction()
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('浏览器\n（当前版本暂时不可用）'), a=_('看会莓博吧，工作滚一边去。'))
                    unhovered Hide("info")   
                ...
                imagebutton auto "gui/phone/shutdown_%s.png":
                    ...
                    hover_sound audio.cursor
                    hovered Show(screen="info", i=_('关机\n是时候做点有用的事了。'), a=_('关掉，关掉，一定要关掉！'))
                    unhovered Hide("info")  
