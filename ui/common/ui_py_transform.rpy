init python:
    ...
    class glitch(renpy.Displayable):
        ...
        def __init__(self, child, randomkey=_stableseed, chroma=True, minbandheight=1, offset=30, *args, **properties):
        ...
        def render(self, width, height, st, at):
            ...
            theights = sorted(randomobj.randrange(0, int(cheight+1)) for k in range(min(cheight, randomobj.randrange(10, 21)))) # y coordinates demarcating all the strips
    ...
    class squares_glitch(renpy.Displayable):
        ...
        def __init__(self, child, randomkey=_stableseed, *args, **kwargs):
        ...
        def glitch(child, cwidth, cheight, randomobj, squareside=20, chroma=.25, permutes=None):
            ...
            ncols = int(cwidth/squareside)
            nrows = int(cheight/squareside)
            ...
            permutes = int(permutes*ncols*nrows)
...
image pathos glitched:
    glitch("pathos", offset=30)
    pause 0.1
    glitch("pathos", offset=30)
    pause 0.1
    glitch("pathos", offset=30)
